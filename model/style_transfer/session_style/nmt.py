...
def train(dim_word=100,  # word vector dimensionality
    ...
    print('Building style embedding distance', end=' ')
                ...
                for jj in range(numpy.minimum(5, x.shape[1])):
                    ...
                    for vv in y[:, jj]:
                        ...
                        if vv in worddicts_r[1]:
                            ...
                            print('UNK', end=' ')
                    print()
                    print('Sample ', jj, ' senti ', senti[jj:jj+1], ': ', end=' ')
                    if stochastic:
                        ss = sample
                    else:
                    ...
                    print('Sample ', jj, ' senti ', 1-senti[jj:jj+1], ': ', end=' ')
                    if stochastic:
                        ss = sample1
                    else:
    ...
    if params is not None:
        numpy.savez(saveto, zipped_params=best_p, history_errs=history_errs, uidx=uidx, **params)
